...
namespace WebAPI {
    ...
    public class api : System.Web.Services.WebService {
        ...
        [WebMethod]
        public void getGameByName(string gameName) {
            addParam("@name", gameName);
            serializeDataTable(sqlExecDataTable("getGameByName"));
        }

        [WebMethod]
        public void getGameByID(int id) {
            addParam("@id", id);
            serializeDataTable(sqlExecDataTable("getGameByID"));
        }

        [WebMethod]
        public void getGames()
        {
            send("getGames", serializeStyle.DATA_TABLE);
        }
        ...
        {
            addParam("@id", id);
            send("getUserByID", serializeStyle.DATA_TABLE);
        }

        [WebMethod]
        public void getAverageRating(int id)
        {
            addParam("@id", id);
            send("getAverageRating", serializeStyle.DATA_TABLE);
        }

        [WebMethod]
        public void getReviewsByGame(int id)
        {
            addParam("@id", id);
